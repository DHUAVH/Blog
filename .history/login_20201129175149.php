            ...
            <div class="col-sm-4 offset-sm-4">    <!--使用网格系统和偏移量设置居中-->                      
                <form role="form" action="loginAction.php" method="POST"> 
                    <div class="text-center">
                        <input class="login_iradius" id="ID" type="text" name="username" 
                            value="<?php echo isset($_COOKIE['username']) ? $_COOKIE['username'] : "";?>"  placeholder="请输入账户" required>
                    </div>
                    
                    <div class="text-center">
                        <input class="login_iradius" id="lastname" type="password" name="password" placeholder="请输入密码" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">                       
                        ...
                        <input class="login_iradius" type="text" name="authcode" placeholder="请输入验证码" required>     
                    </div>
