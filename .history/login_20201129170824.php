...
<body>
    <div class="container">
    <div class="justify-text-center"><h1>登录</h1> </div>
    <div class="row">                         
                ...
                <form role="form" action="loginAction.php" method="POST"> 
                    <div class="justify-content-center">
                        <input id="ID" type="text" name="username" 
                            ...
                            <input type="password" id="lastname" name="password" placeholder="请输入密码" required></td>
                            ...
                            <td colspan="2" class="text-center" style="color:red;font-size:10px;">
                                ...
                                <input type="text" name="authcode" placeholder="请输入验证码" required></p>  
