    ...
    <form action="edit.php" method="post">
        <div class="card">
            <div class="card-header">
                博文标题:<textarea rows="1" cols="100" name="title" placeholder="输入博文标题"><?php echo $rs['title'];?></textarea>
            </div>
                
            <div class="card-body">
                博文内容:<textarea rows="10" cols="100" name="con" placeholder="输入博文内容"><?php echo $rs['content'];?></textarea>
            </div>
        </div>  
