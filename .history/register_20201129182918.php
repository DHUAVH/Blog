        ...
        <div class="row">
            <div class="col-sm-4 offset-sm-4">
                <form action="registerAction.php" method="POST">
                    ...
                    <div class="text-center">
                        <input class="_input" type="email" name="email" placeholder="请再次输入密码"  required>
                    </div>

                    <div class="text-center">
                        <input class="_input" type="text" name="phone" placeholder="请再次输入手机号码"  required>
                    </div> 
                    ...
                    <div class="text-center">
                        <span colspan="2" >如果已有账号，快去<a href="login.php">登录</a></span>
                    </div>  
                </form>
            </div>
        </div>
